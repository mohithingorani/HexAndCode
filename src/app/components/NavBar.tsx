      ...
      <div className="flex flex-row gap-8 justify-between w-full">
        <div className="flex items-center justify-start w-[70%] gap-6">
          <Image
            ...
            height={30}
          />
          <button className="flex text-white border px-3 py-1.5 border-white rounded-lg justify-between items-center gap-1 hover:bg-white hover:text-black transition ml-8 mr-4">
            <div className="text-lg font-semibold">Learn With Friend</div>
            <Image src="/down.svg" alt="down" width={17} height={17} />
          </button>
