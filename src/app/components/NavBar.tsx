    ...
    <div className="w-full bg-[#0C0807] px-9 py-16 text-white z-10">
      <div className="flex items-center justify-between w-full">
          <Image
            ...
            height={30}
          />
        <button className="flex w-36  text-white border px-3 py-1.5 border-white rounded-lg justify-between items-center gap-1 hover:bg-white hover:text-black transition">
          <div className="text-lg font-semibold">EXPLORE</div>
          <Image src="/down.svg" alt="down" width={17} height={17} />
        </button>

        <div className="flex items-center border border-white rounded-full overflow-hidden max-w-3xl w-full mx-4 h-12 self-start">
          <input
            type="text"
          ...
          />
          <button>
            <Image className="w-full h-full p-1 mr-2 " src="/searchlogo.svg" alt="Search" width={50} height={50} />
          </button>
        </div>
