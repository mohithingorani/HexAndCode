...
return (
    <div
        className="relative flex flex-col items-start pl-32  justify-center w-full h-screen bg-cover bg-center  border-black "
        style={{ backgroundImage: 'url("/bgnew.png")'  }}
        draggable={false} // Add draggable false
    >
        ...
        <div className="text-white text-6xl font-semibold z-10">
            ...
            <div className="flex gap-2 items-end mt-10">
                ...
                <div className="text-2xl font-light flex flex-col items-end h-full justify-end">
                    <div className="h-fit">
                        courses on cutting-edge Tech and Design tailored for you
                    </div>
                </div>
            </div>
            <div></div>
